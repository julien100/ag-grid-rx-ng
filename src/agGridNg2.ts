...
import {Grid, GridOptions, GridApi, ColumnApi, GridParams, ComponentUtil} from "ag-grid-rx/main";
...
export class AgGridNg2 implements AfterViewInit {
    ...
    @Input() public rowDataSource: any = undefined;
    @Input() public rowDataSourceKeyProperty: any = undefined;
